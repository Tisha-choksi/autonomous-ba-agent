...
const CSS = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  html { background: #020812 !important; scroll-behavior: smooth; }
  body {
  ...
  @keyframes borderGlow {
    0%,100% { box-shadow:0 0 0 1px rgba(0,212,255,0.15),0 0 24px rgba(0,212,255,0.06); }
    50%     { box-shadow:0 0 0 1px rgba(0,212,255,0.4),0 0 48px rgba(0,212,255,0.13); }
  }
  ...
  .anim-glow     { animation:borderGlow 3.5s ease-in-out infinite; }
  ...
  .grid-bg {
    ...
    background-image:
      linear-gradient(rgba(0,212,255,0.042) 1px, transparent 1px),
      linear-gradient(90deg, rgba(0,212,255,0.042) 1px, transparent 1px);
  ...
  .status-dot {
    ...
    background:#00FF94; position:relative;
    display:inline-block; flex-shrink:0;
  }
  .status-dot::after {
    content:''; position:absolute; inset:-3px; border-radius:50%;
    background:#00FF94; opacity:0.22;
  ...
  .sidebar-link.active::before {
    ...
    background:#00D4FF; border-radius:0 3px 3px 0;
